...
class Interface(Node):
    ...
    def __init__(
        ...
        self.object_global_position_x = 0.0
        self.object_global_position_y = 0.0

        self.object_local_position_x = 0.0
        self.object_local_position_y = 0.0
    ...
    def object_location_callback(self, msg):
        ...
        self.object_local_position_x = (
            msg.data[0] if msg.data[0] is not None else 0
        )
        self.object_local_position_y = (
            msg.data[1] if msg.data[1] is not None else 0
        )
        self.object_distance = msg.data[2] if msg.data[2] is not None else 0
        # if (
    ...
    def straight_line(self, args=None):
        cmd = Float32MultiArray()
    ...
    def Object_Detection(
        ...
        # self.Unique_Object()
        if (object_list[self.obj_list_index] == self.object_name) and (
            self.object_distance <= distance_threshold
        ):
            reference_x = self.object_local_position_x
            reference_y = self.object_local_position_y
    ...
    def Run(self, args=None):
        function_dict = {
            ...
            "Lane_Following": self.straight_line,
