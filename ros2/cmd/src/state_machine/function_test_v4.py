...
from state_machine.car_sm import CarSM
...
class FunctionTest(Node):
    def __init__(self, lane_change, lane_follow):
        ...
        self.car_sm = CarSM()
        self.img_path = "/home/autonomylab/selfdrive/ros2/cmd/src/state_machine/diagrams/live_SM.png"
