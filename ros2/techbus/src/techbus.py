...
class ROStouCAN(Node):
    ...
    def cmd_callback(self, msg):
        ...
        if msg.linear.x != 0 and msg.angular.z != 0:
            ...
            self.get_logger().info(f"Warning: invalid steering angle combo:lin.x:{msg.linear.x}, ang.z:{msg.angular.z}")
            angle = 0
...
class CANtouROS(Node):
    ...
    def timer_callback(self):
        ...
        encoder_msg.data = [data['CTRL_encoderLeft'], data['CTRL_encoderRight']]
