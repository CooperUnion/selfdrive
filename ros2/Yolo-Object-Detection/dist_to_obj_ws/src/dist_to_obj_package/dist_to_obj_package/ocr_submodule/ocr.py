...
config = r'--psm 11 --oem 3 --tessdata-dir /usr/share/tesseract-ocr/4.00/tessdata'
            ...
            if float(data['conf'][i]) > self.conf:
                ...
                if data["text"][i].lower() == 'stop':
                    ...
                    annotated_img = cv2.rectangle(
                        annotated_img, (x, y), (x + width, y + height), (0, 255, 0), 2)
                ...
                if data["text"][i].lower() == 'igvc' or data["text"][i].lower(
                ) == 'icvc' or data["text"][i].lower() == 'soup':
