    ...
    def __init__(self):
        ...
        self.imgData_subscriber = self.create_subscription(
            ...
            lambda msg: self.camData_callback(
                msg, (self._frame_containers[0][0], self._frame_containers[0][1])),
        ...
        self.hsvData_subscriber = self.create_subscription(
            ...
            '/camera/image_hsv',
            lambda msg: self.camData_callback(
                msg, (self._frame_containers[1][0], self._frame_containers[1][1])),
            qos_profile_sensor_data)

    def tabs(self, tabs):
        self._tabs = tabs
        self._frame_containers = [(tab.empty(), tab.empty())
