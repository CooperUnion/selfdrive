...
class DBC:
    ...
    @cache
    def get_msg_by_frame_id(self, frame_id: int) -> cantools.database.can.message.Message:
        return self._dbc.get_message_by_frame_id(frame_id)

    @cache
    def get_msg_by_name(self, name: str) -> cantools.database.can.message.Message:
