...
static void burst_read_register(uint8_t address); 
...
void burst_read_register(uint8_t address) {

	uint16_t Burst_reg1, Burst_reg2, Burst_reg3, Burst_reg4, Burst_INT_status;
