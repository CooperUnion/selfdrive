...
#----------------
    ...
    # Control loop
        ...
        #         print("step amount: " + str(key_in.step_amount))
            ...
            desired_pos = bus.get('dbwNode_Steer_Cmd')

            bus.send("dbwNode_Steer_Data", {"Vel_Estimate": axis.encoder.vel_estimate,"Pos_Estimate": axis.encoder.pos_estimate})
        ...
        # Check if odrive axis has any errors!
            if(axis.error != 0): 
                ...
                bus.send("dbwNode_Status", {"SystemStatus": "UNHEALTHY"})   #Is this okay? 
                raise Exception
