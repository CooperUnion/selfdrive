...
class path_generation: 
    ...
    def vertical_line(self,start_point,start_orientation,num_path_points):
        ...
        goal_point = Point(0 + start_orientation.x, 10 + start_orientation.y) #assume in ft
    ...
    def horizontal_line(self,start_point,start_orientation,num_path_points):
        global TYPE 
        TYPE = 2
        # start_point = Point(0, 114) 
        # start_orientation = 0
        goal_point = Point((19.25/2) + start_orientation.x, 114 + start_orientation.y) #assume in ft
        goal_orientation = 0
    ...
    def right_turn(self,start_point,start_orientation,num_path_points):
        global TYPE 
        TYPE = 3
        # start_point = Point((0), 0) 
        # start_orientation = np.pi / 2
        goal_point = Point( start_orientation.x + (5.76), start_orientation.y + 5.76) #assume in m
        goal_orientation = 0
    ...
    def left_turn(self,start_point,start_orientation,num_path_points):
        global TYPE 
        TYPE = 4
        # start_point = Point(0,0) 
        # start_orientation =  np.pi / 2
        goal_point = Point(start_orientation.x + (-9.5), start_orientation.y + (9.5)) #assume in ft
    ...
    def swerve_R2L(self,start_point,start_orientation,num_path_points):
        global TYPE 
        TYPE = 5
        # start_point = Point(0,0) 
        # start_orientation =  np.pi / 2
        goal_point = Point(start_orientation.x + (4.25), start_orientation.y + (8)) #assume in ft
        goal_orientation = np.pi / 2
        # num_path_points = 100
        ...
        return swerve
    def swerve_L2R(self,start_point,start_orientation,num_path_points):
...
def main(): 
    ...
    path = make_path.vertical_line(start_point,start_orientation,goal_point,goal_orientation)
